...
const featuredCourses = [
  {
    id: 1,
    title:
      "Mô phỏng tình huống cháy chung cư mini và kỹ năng thoát nạn an toàn.",
    category: "Cơ bản",
    categoryKey: "co-ban",
    thumbnail: "Chaychungcu_Thumbnail.png",
    description:
      "Tái hiện tình huống cháy thực tế tại chung cư mini. Học cách ứng phó đúng khi xảy ra hỏa hoạn tại nhà cao tầng và ký túc xá.",
  },
  {
    id: 2,
    ...
    description:
      "Đối mặt với tình huống cháy do chập bình nóng lạnh trong phòng trọ nhỏ. Quyết định sinh tử trong tích tắc khi phòng dần mất dưỡng khí.",
  },
  {
    id: 3,
    ...
    description:
      "Nhận biết sớm cháy điện, tránh sai lầm hắt nước gây giật, dùng bình chữa cháy chuyên dụng và nhanh chóng thoát hiểm để bảo vệ tính mạng.",
  },
];
...
const testimonials = [
  {
    ...
    avatar: "MT",
    content:
      "Khoá học PCCC ở FIREGUARD rất dễ hiểu, video minh hoạ trực quan. Mình biết cách dùng bình chữa cháy ngay sau bài đầu tiên.",
    rating: 5,
  },
  {
    name: "Trần Thu Hà",
    ...
    avatar: "TH",
    content:
      "Đem nội dung này vào tiết sinh hoạt cho học sinh, các em hứng thú và làm bài quiz đạt điểm rất cao.",
    rating: 5,
  },
  {
    name: "Lê Quang Huy",
    ...
    avatar: "QH",
    content:
      "Đăng ký cho 30 nhân viên bảo vệ cùng học. Mỗi bài chỉ 1-2 phút, vừa đủ ngắn để tranh thủ giờ giải lao.",
    rating: 5,
  },
  {
    ...
    avatar: "KL",
    content:
      "Phần thoát hiểm khi cháy chung cư rất sát thực tế. Tương tác qua câu hỏi giúp mình nhớ kiến thức lâu hơn hẳn.",
    rating: 4,
  },
  {
    name: "Đỗ Anh Khoa",
    ...
    avatar: "AK",
    content:
      "Cho con học cùng để biết kỹ năng sống còn. Phụ huynh hoàn toàn yên tâm khi để con tự học một mình trên nền tảng.",
    rating: 5,
  },
  {
    name: "Bùi Thị Mai",
    ...
    avatar: "TM",
    content:
      "Giảng viên trả lời comment rất nhanh. Câu hỏi nào cũng được giải đáp trong ngày. Rất đáng để đăng ký!",
    rating: 5,
  },
];
...
const COURSE_FRAMES = {
  chungcu:
    "https://res.cloudinary.com/dzasig10l/video/upload/so_15,w_640,h_360,c_fill,q_auto/v1782235650/sources-6a1a9d24d11b2_afpqin.jpg",
  trongnha:
    "https://res.cloudinary.com/dzasig10l/video/upload/so_15,w_640,h_360,c_fill,q_auto/v1782234076/sources-6a1af9db9c0aa_ls6wjr.jpg",
  ...
  amdunnuoc:
    "https://res.cloudinary.com/dzasig10l/video/upload/so_15,w_640,h_360,c_fill,q_auto/v1782235450/files-6a353f5a413e0_cwbln4.jpg",
};
const FRAME_FALLBACK = [
  COURSE_FRAMES.chungcu,
  COURSE_FRAMES.trongnha,
  COURSE_FRAMES.mini,
  COURSE_FRAMES.amdunnuoc,
];
...
function Homepage({
  ...
  const displayName = user
    ? user.fullName || user.name || user.email || "Học viên"
    : "";
  const handleMenu = (fn) => {
    setUserMenuOpen(false);
    if (fn) fn();
  ...
  const displayCourses =
    videos && videos.length ? videos.slice(0, 3) : featuredCourses;
    ...
    <div className="homepage-root" ref={rootRef}>
      ...
      <nav className={`hp-navbar${scrolled ? " hp-navbar-scrolled" : ""}`}>
        <div className="hp-navbar-inner">
          ...
          <div className="hp-nav-links">
            <button
              onClick={() => scrollToSection("hp-courses")}
              className="hp-nav-link"
            >
              Khóa học
            </button>
            <button
              onClick={() => scrollToSection("hp-benefits")}
              className="hp-nav-link"
            >
              Lợi ích
            </button>
            <button
              onClick={() => scrollToSection("hp-testimonials")}
              className="hp-nav-link"
            >
              Ý kiến
            </button>
            <button
              onClick={() => scrollToSection("hp-faq")}
              className="hp-nav-link"
            >
              Hỏi đáp
            </button>
            <button
              onClick={() => scrollToSection("hp-contact")}
              className="hp-nav-link"
            >
              Liên hệ
            </button>
          ...
          <div className="hp-nav-actions">
            {user ? (
              <div className="hp-nav-user-menu" ref={userMenuRef}>
                ...
                >
                  <span className="hp-nav-avatar">
                    {displayName.charAt(0).toUpperCase()}
                  </span>
                  <span className="hp-nav-username">{displayName}</span>
                  <span className="hp-nav-caret" aria-hidden="true">
                    ▾
                  </span>
                </button>
                ...
                {userMenuOpen && (
                  <div className="hp-nav-dropdown" role="menu">
                    <div className="hp-nav-dd-header">
                      <span className="hp-nav-dd-avatar">
                        {displayName.charAt(0).toUpperCase()}
                      </span>
                      <div className="hp-nav-dd-id">
                        <span className="hp-nav-dd-name">{displayName}</span>
                        {user.email && (
                          <span className="hp-nav-dd-email">{user.email}</span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="hp-nav-dd-divider" />
                    <button
                      className="hp-nav-dd-item logout"
                      role="menuitem"
        ...
        <div className="hp-hero-content">
          <div className="hp-hero-text-col">
            ...
            <h1 className="hp-hero-heading">
              Học kỹ năng{" "}
              <span className="hp-hero-highlight hp-flame-text">
                phòng cháy chữa cháy
              </span>{" "}
              qua mô phỏng tương tác thực tế
            </h1>
            <p className="hp-hero-subtitle">
              Trang bị cho bản thân và gia đình kiến thức sống còn chỉ trong vài
              phút mỗi ngày. Video bài giảng trực quan, tình huống mô phỏng chân
              thực, bài kiểm tra tương tác.
            </p>

            <div className="hp-hero-cta-row">
              <button
                className="hp-btn hp-btn-primary hp-btn-lg hp-btn-flame"
            ...
            {/* Live stats row */}
            <div
              className={`hp-hero-stats${animatedStats ? " hp-hero-stats-visible" : ""}`}
            >
          ...
          <div className="hp-hero-visual-col">
            <div className="hp-hero-card">
              ...
              <div className="hp-hero-card-body">
                <span className="hp-hero-card-badge">
                  🔥 Đang phát trực tiếp
                </span>
                ...
                <div className="hp-hero-card-progress">
                  <div className="hp-hero-card-progress-bar">
                    <div
                      className="hp-hero-card-progress-fill"
                      style={{ width: "68%" }}
                    ></div>
                  </div>
                  <span className="hp-hero-card-progress-text">
                    {totalStudents != null
                      ? totalStudents.toLocaleString("vi-VN")
                      : "2.450"}{" "}
                    học viên đang học
      ...
      <section className="hp-section" id="hp-courses">
        <div className="hp-section-header hp-reveal">
          ...
          <h2 className="hp-section-title">
            Lộ trình học tập PCCC từ cơ bản đến nâng cao
          </h2>
          <p className="hp-section-desc">
            Mỗi bài học là một tình huống mô phỏng thực tế, giúp bạn rèn luyện
            phản xạ và kỹ năng xử lý khi gặp hỏa hoạn.
          </p>
        </div>
          ...
          {displayCourses.map((course, idx) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url('${getCourseThumb(course, idx)}')`,
                }}
              >
                <div
                ...
                <span
                  className={`hp-course-cat-tag hp-course-cat-${course.categoryKey}`}
                >
                  {course.category}
                </span>
              ...
              <div className="hp-course-body">
                ...
                <div className="hp-course-footer-row">
                  <span className="hp-course-duration">
                    ...
                    {course.duration && String(course.duration).trim()
                      ? course.duration
                      : "1-2 phút"}
                  </span>
                  <button
      ...
      <section className="hp-section hp-section-alt" id="hp-benefits">
        <div className="hp-section-header hp-reveal">
          ...
          <h2 className="hp-section-title">
            Nền tảng học PCCC khác biệt và hiệu quả
          </h2>
          <p className="hp-section-desc">
            Chúng tôi kết hợp công nghệ mô phỏng tương tác và phương pháp sư
            phạm hiện đại để bạn học nhanh, nhớ lâu.
          </p>
        </div>
      ...
      <section className="hp-section" id="hp-testimonials">
        <div className="hp-section-header hp-reveal">
          <span className="hp-section-tag">Ý kiến từ học viên</span>
          <h2 className="hp-section-title">
            Hơn{" "}
            {totalStudents != null
              ? totalStudents.toLocaleString("vi-VN")
          ...
          <p className="hp-section-desc">
            Học viên từ nhiều lứa tuổi và ngành nghề đã tin tưởng và gắn bó cùng
            FIREGUARD.
          </p>
        </div>
      ...
      <section className="hp-section hp-section-alt" id="hp-faq">
        <div className="hp-section-header hp-reveal">
          ...
          <p className="hp-section-desc">
            Những thắc mắc phổ biến nhất từ học viên trước khi bắt đầu hành
            trình học PCCC.
          </p>
        </div>
        ...
        <div className="hp-faq-list hp-reveal">
          {faqs.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`hp-faq-item${open ? " hp-faq-open" : ""}`}
              >
                <button
      ...
      <section className="hp-emergency">
        <div className="hp-emergency-inner hp-reveal">
          ...
          <div className="hp-emergency-text">
            <span className="hp-emergency-label">
              Khi có cháy, hãy gọi ngay
            </span>
            <p href="tel:114" className="hp-emergency-number">
              114
            </p>
      ...
      <section className="hp-cta-banner">
        ...
        <div className="hp-cta-banner-content">
          ...
          <p className="hp-cta-banner-text">
            Đăng ký tài khoản miễn phí ngay hôm nay và bắt đầu bài học đầu tiên.
            Chỉ mất vài phút!
          </p>
          <div className="hp-cta-banner-buttons">
            ...
            >
              ...
              <span className="hp-btn-arrow" style={{ marginLeft: "8px" }}>
                →
              </span>
            </button>
            <button
              className="hp-btn hp-btn-white-ghost hp-btn-lg"
              onClick={() => setView("login")}
            >
              Tôi đã có tài khoản
            </button>
      ...
      <footer className="hp-footer" id="hp-contact">
        <div className="hp-footer-grid">
          ...
          <div className="hp-footer-col hp-footer-col-brand">
            ...
            <p className="hp-footer-brand-desc">
              Nền tảng học tập kỹ năng phòng cháy chữa cháy tương tác hàng đầu
              Việt Nam. Sứ mệnh của chúng tôi là trang bị kiến thức PCCC cho mọi
              người dân.
            </p>
          </div>
          ...
          <div className="hp-footer-col">
            ...
            {(videos && videos.length ? videos : featuredCourses)
              .slice(0, 4)
              .map((c) => (
                <button
                  key={c.id ?? c._id}
        ...
        <div className="hp-footer-bottom">
          <p>
            © {new Date().getFullYear()} FIREGUARD. Tất cả quyền được bảo lưu.
          </p>
